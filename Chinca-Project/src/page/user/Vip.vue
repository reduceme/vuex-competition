<template>
  <div>
    ...
    <div class="user-vip">
      <div class="vip-info">
        <div class="normal-user" v-if="!user.isVip">
          ...
          <el-button type="primary" @click.native="invoiceShow">发票信息</el-button>
        </div>
    ...
    <invoice-modal ref="invoice"></invoice-modal>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    getScoreInfo () {
      this.$ajax.get('/common/scoreDeclare').then(res => {
