      ...
      <el-table class="application"
        ...
        <el-table-column
          ...
          <template scope="scope">
            ...
            <el-button type="text" v-show="scope.row.orderStatus === 5" class="div" @click="openScoreModal(scope.row.id)">设置成功</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <edit-app-show></edit-app-show>
    <app-score :orderid="orderid"></app-score>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...mapActions([
      'showModal', 'showData', 'showScoreModal'
    ]),
    showCartList () {
