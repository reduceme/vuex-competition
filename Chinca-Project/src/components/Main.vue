    ...
    <el-header>
      <el-row :gutter="24">
        <el-col :span="8" class="col-8">
          <h3 class="grid-content bg-purple">工程技术标准数据库管理平台</h3>
        </el-col>
    ...
    <el-container>
      <el-aside width="270px">
        ...
        <div class="aside-item">
          ...
          <div class="aside-list"><router-link :to="'/sort-ics'" >国际标准·分类</router-link></div>
          <div class="aside-list"><router-link :to="'/sort-css'" >中国标准·分类</router-link></div>
        </div>
        <!--个人中心-->
        <div class="aside-item">
          ...
          <div class="aside-list"><router-link :to="'/about'" >关于我们</router-link></div>
        </div>
