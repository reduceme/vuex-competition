...
import CriterionTypeSearch from '../components/fieldComponents/FieldTypeSearch'
import CriterionTypeList from '../components/fieldComponents/FieldTypeList.vue'
...
export default {
  ...
  methods: {
    changeSearchData (val) {
      console.log(val);
      this.integralPageInfo.fNum = val.fnum
      this.integralPageInfo.fName = val.fname
      this.getScoreList()
    },
    /* *
     * 分页大小改变
    ...
    getScoreList: function () {
      Axios.get('/type/get_stfield', {
        params: {
          fNum: this.integralPageInfo.fNum,
          fName: this.integralPageInfo.fName,
