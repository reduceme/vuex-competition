...
import CriterionTypeSearch from '../components/OrganizationSettlement/InfoSearch'
import CriterionTypeList from '../components/OrganizationSettlement/InfoList.vue'
