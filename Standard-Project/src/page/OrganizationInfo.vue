...
import CriterionTypeSearch from '../components/OrganizationInfoComponents/InfoSearch'
import CriterionTypeList from '../components/OrganizationInfoComponents/InfoList.vue'
...
export default {
  ...
  methods: {
    ...
    getScoreList: function () {
      Axios.get('/org/get_org', {
        params: {
          orgNum: this.integralPageInfo.orgNum,
          orgName: this.integralPageInfo.orgName,
        ...
        if (response.status === 200) {
          ...
          console.log(this.tableListInfo.tableData );
